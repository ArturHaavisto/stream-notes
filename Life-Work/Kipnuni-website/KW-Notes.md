...
- Press a button, the normal website look will change into a top down 2.5d game, where the user can move the character to explore the website
- When the navigation button is pressed, have the card to move to the opposite direction. Before showing the next page, if it's not loaded, show the transition animation/page and then with a similar small animation/transition bring the next page
